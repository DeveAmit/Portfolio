  ...
  return (
    ...
    >
      <div className="grid place-items-center mt-auto gap-5">
        ...
        <a data-aos="fade in" data-aos-delay="900" href="mailto:amit.engg9897@gmail.com">
          <div className="shadow-xl shadow-slate-900 font-bold cursor-pointer text-white p-4 bg-gradient-to-br from from-pink-500 to-red-400 hover:from-slate-600 hover:to-zinc-900 md:hover:scale-105 transition rounded-xl w-fit">
            Send Message
          </div>
        </a>
      </div>
