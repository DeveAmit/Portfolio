  ...
  return (
    <section className="max-w-screen-lg mx-auto w-full pt-20 min-h-screen flex flex-col justify-between px-5 lg:px-0">
      <div data-aos="fade-in" className="flex flex-1 flex-col md:flex-row items-center justify-between gap-4">
        <Hero />
        <div className="">
          <img src="./img/hero-img.jpg" className="h-72" alt="Avatar" />
        </div>
      </div>
      <div data-aos="fade-in" data-aos-delay="100" className="flex py-8 justify-center md:justify-start items-center gap-4">
        ...
        <a target="_blank" href="https://www.github.com/DeveAmit" className="fill-slate-600 md:hover:scale-110 md:transition md:hover:fill-emerald-500" >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
        ...
        <a href="./Resume.pdf" className="">
          <div className="bg-transparent hover:bg-emerald-500 text-emerald-500 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded">
            Download CV
          </div>
        </a>
      </div>
