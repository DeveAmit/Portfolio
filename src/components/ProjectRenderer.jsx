      ...
      <div data-aos="fade-in" data-aos-delay="300" className="col-span-2 pl-5 lg:px-0">
        <div className="py-8 h-full flex flex-col gap-4 justify-between">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs py-1 px-2 bg-slate-400 rounded-xl text-white shadow-md shadow-slate-900">
          ...
          <div className="flex items-center gap-4">
            ...
            <div
              className="shadow-xl md:hover:scale-105 transition shadow-slate-900 cursor-pointer p-4 bg-gradient-to-br from-pink-400 to-violet-600 w-fit text-sm select-none font-bold rounded-lg text-white hover:from-slate-600 hover:to-zinc-900"
              onClick={() => handleNext()}
            >
              Next Project
            </div>
